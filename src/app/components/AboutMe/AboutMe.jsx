...
const AboutMe = () => {
  return (
    <div>
      ...
      <div>
        <img src="https://i.postimg.cc/sX3dqyPM/ccc406dbafc09f3ac2f066a494af21e7.jpg" className="border-primary border-2 md:ml-16 md:translate-x-5 md:translate-y-10 transform rotate-12 hover:rotate-0 hover:transition hover:duration-1000 hover:border-violet-300 mt-12 md:mt-32 rounded-3xl h-[400px] w-[400px]" alt="" />
      </div>
    </div>
